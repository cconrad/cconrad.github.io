...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("fixBackslashInLdJson", function (value) {
...
function extractExcerpt(article) {
  ...
  if (article.data && article.data.excerpt) {
    return article.data.excerpt;
  }

  if (article.data && article.data.teaser) {
    return article.data.teaser;
  }
