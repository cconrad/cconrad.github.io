	...
	parseJSON: function( data ) {
		...
		if ( typeof data === "string" ) {
			...
			if ( data ) {
				...
				// Logic borrowed from https://www.json.org/json-en.html
...
var i,
	...
	// Whitespace characters https://www.w3.org/TR/selectors-3/#whitespace
	whitespace = "[\\x20\\t\\r\\n\\f]",
	// https://www.w3.org/TR/css-syntax-3/#characters
	characterEncoding = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",

	// Loosely modeled on CSS identifier characters
	// An unquoted value should be a CSS identifier https://www.w3.org/TR/selectors-3/#attribute-selectors
